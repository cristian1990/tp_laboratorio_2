    ...
    public partial class frmWebBrowser : Form
    {
        ...
        private void btnIr_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                Uri uri = new Uri(url);
                Descargador descarga = new Descargador(uri);
                descarga.progreso += new Descargador.Progreso(this.ProgresoDescarga);
                descarga.descargaCompleta += new Descargador.DescargaCompleta(this.FinDescarga);
                Thread hilo = new Thread(descarga.IniciarDescarga);
                hilo.Start();
                this.archivos.Leer(out listaHist);
