...
namespace Entidades_2017
{
    ...
    public sealed class Changuito
    {
        ...
        /// <returns></returns>
        public string Mostrar(Changuito concecionaria, ETipo tipoDeChanguito) //quitar static
        {
            StringBuilder sb = new StringBuilder();

            sb.AppendFormat("Tenemos {0} lugares ocupados de un total de {1} disponibles", concecionaria._productos.Count, concecionaria._espacioDisponible);
            sb.AppendLine("");
            sb.AppendLine("");
            foreach (Producto prod in concecionaria._productos)
            {
